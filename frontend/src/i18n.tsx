...
const en = {
  ...
  auth_hero_tag: 'One clear operation', auth_hero_title: 'Orders, inventory, and customers—together.',
...
const th: typeof en = {
  ...
  auth_hero_tag: 'จัดการทุกอย่างในที่เดียว', auth_hero_title: 'ออเดอร์ สต็อก และลูกค้า—เชื่อมถึงกัน',
